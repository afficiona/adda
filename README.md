...
Frontend runs on http://localhost:3102

## Usage

1. **Register**: Create a new account at http://localhost:3102/register
...
Adda acts as an OAuth 2.0 provider, allowing applications like Prasaran to:
...
- Secondary: Cyan (`cyan-600`, `cyan-700`)
- Accents: Teal gradients
